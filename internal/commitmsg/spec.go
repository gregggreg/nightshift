...
Rules
  ...
  - messages git writes itself are exempt: "Merge branch/branches/tag/
    commit/pull request/remote-tracking branch ...", 'Revert "...', and
    'fixup! ', 'squash! ' or 'amend! ' headers are always accepted, so
